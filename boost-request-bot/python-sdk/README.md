...
- API version: 1.0
- Package version: refs/tags/v1.4.1
...
------------ | ------------- | ------------- | -------------
*UsersApi* | [**users_user_id_steal_credits_get**](docs/UsersApi.md#users_user_id_steal_credits_get) | **GET** /users/{userId}/stealCredits | 
*UsersApi* | [**users_user_id_steal_credits_patch**](docs/UsersApi.md#users_user_id_steal_credits_patch) | **PATCH** /users/{userId}/stealCredits | 
