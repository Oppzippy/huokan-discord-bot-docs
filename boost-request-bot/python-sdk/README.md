...
- API version: 1.0
- Package version: refs/tags/v1.4.0
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**users_user_id_steal_credits_get**](docs/DefaultApi.md#users_user_id_steal_credits_get) | **GET** /users/{userId}/stealCredits | 
*DefaultApi* | [**users_user_id_steal_credits_patch**](docs/DefaultApi.md#users_user_id_steal_credits_patch) | **PATCH** /users/{userId}/stealCredits | 
